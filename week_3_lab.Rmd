...
Informative: something like beta(5,1). First, It's not very likeli that after training, students get worse, so I put no weight below zero. On the other hand, the improvement is not likely to be as high as 0.9 or something, so I put more weight on small positive values. Arguably, we can put some weight on the negative part.
